...
data = Data(datas_path + "Third_datas.xls", "新疆")
param = data.get_data()
cookies = cookies_xinjiang
...
class Third_02_clzxl_test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        driver = Browser_engine.get_browser()
        cls.index = Third_pages_01.Third_pages_login(driver)
        # cls.index.Third_open("http://10.50.10.117:8080/#/statistics/vehicle_real_situation")
        cls.index.max_window()
        # cls.index.Third_open(param[1]["url"])
        cls.index.Third_open(param[1]["url"])
        cls.index.add_cookies(cookies)
